...
import { MdOutlinePayments, MdDoneOutline } from 'react-icons/md';
...
const Payment = () => {
    ...
    return (
        <section className="payment">
            ...
            {clicked === true &&
            <Link to="/DONE" className="done"> <button type="submit" className="doneBtn" onClick={handleDeleteCart}>ZAPŁAĆ</button></Link>
            }
